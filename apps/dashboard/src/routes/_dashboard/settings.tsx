...
import { useSettings, useUpdateSettings, useCreateSettings } from '@/hooks/use-settings'
      ...
      <Tabs defaultValue="site" className="space-y-6">
        <TabsList className="grid w-full max-w-md grid-cols-3">
          <TabsTrigger value="site" className="gap-2">
            <Globe className="h-4 w-4 hidden sm:inline" />Site
          </TabsTrigger>
          <TabsTrigger value="appearance" className="gap-2">
            <Palette className="h-4 w-4 hidden sm:inline" />Theme
          </TabsTrigger>
          <TabsTrigger value="security" className="gap-2">
            <Shield className="h-4 w-4 hidden sm:inline" />Security
          </TabsTrigger>
        </TabsList>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4 sm:grid-cols-3">
                <div className="relative">
                  <input type="radio" name="theme" id="light" className="peer sr-only" defaultChecked />
                  <label htmlFor="light" className="block p-4 border rounded-lg cursor-pointer peer-checked:border-primary peer-checked:ring-2 peer-checked:ring-primary/20">
                    <div className="h-20 rounded bg-white border mb-2" />
                    <p className="font-medium text-sm">Light</p>
                  </label>
                </div>
                <div className="relative">
                  <input type="radio" name="theme" id="dark" className="peer sr-only" />
                  <label htmlFor="dark" className="block p-4 border rounded-lg cursor-pointer peer-checked:border-primary peer-checked:ring-2 peer-checked:ring-primary/20">
                ...
                <div className="relative">
                  ...
                  <label htmlFor="system" className="block p-4 border rounded-lg cursor-pointer peer-checked:border-primary peer-checked:ring-2 peer-checked:ring-primary/20">
...
function SiteSettingsForm({ settings }: { settings: ReturnType<typeof useSettings>['data'] }) {
    ...
    <form onSubmit={handleSubmit}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure your portfolio site settings</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="grid gap-2">
              ...
              <Select 
                ...
                onValueChange={(v) => setFormData({ ...formData, defaultLanguage: v as Language })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
